...
class Baseline():
    ...
    def num_to_coord(self, num, WORLD_WIDTH):
        r, c = num//WORLD_WIDTH, num %WORLD_WIDTH
        return (r, c)

    def coord_To_Num(self, coord, WORLD_WIDTH):
        r, c = coord[0], coord[1]
        return r*WORLD_WIDTH + c # num from 0 to 99

    def eplisonGreedy(self, s, Q, eplison, WORLD_WIDTH=10):
    ...
    def dyna_q(self, iter, Q, reward_model, nextS_model, env, proxy_reward, WORLD_WIDTH, scr=None, plan_count=5, n=3000, eplison=0.1, alpha=0.01, discount=0.95):
    ...
    def agent_learn(self, proxy_reward):
        ...
        # solution_policy_scores, solution_policy_traj_phi, solution_traj = run_test_exp(env, proxy_reward, solution_policy, DISCOUNT,False)
        # if training_env:
